...
function hashMarketConfigKeys(market) {
    ...
    return (0, hash_1.hashDataMap)({
        ...
        maxLendableImpactFactor: [
            ["bytes32", "address"],
            [dataStore_1.MAX_LENDABLE_IMPACT_FACTOR_KEY, marketAddress],
        ],
        maxLendableImpactFactorForWithdrawals: [
            ["bytes32", "address"],
            [dataStore_1.MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS_KEY, marketAddress],
        ],
        maxLendableImpactUsd: [
            ["bytes32", "address"],
            [dataStore_1.MAX_LENDABLE_IMPACT_USD_KEY, marketAddress],
        ],
        lentPositionImpactPoolAmount: [
            ["bytes32", "address"],
            [dataStore_1.LENT_POSITION_IMPACT_POOL_AMOUNT_KEY, marketAddress],
        ],
        minCollateralFactor: [
            ["bytes32", "address"],
        ...
        minCollateralFactorForLiquidation: [
            ["bytes32", "address"],
            [dataStore_1.MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY, marketAddress],
        ],
