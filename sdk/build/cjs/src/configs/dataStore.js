...
exports.SWAP_IMPACT_POOL_AMOUNT_KEY = exports.POSITION_IMPACT_POOL_DISTRIBUTION_RATE_KEY = exports.MIN_POSITION_IMPACT_POOL_AMOUNT_KEY = exports.POSITION_IMPACT_POOL_AMOUNT_KEY = exports.LENT_POSITION_IMPACT_POOL_AMOUNT_KEY = exports.MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS_KEY = exports.MAX_LENDABLE_IMPACT_USD_KEY = exports.MAX_LENDABLE_IMPACT_FACTOR_KEY = exports.CLAIMABLE_COLLATERAL_TIME_DIVISOR_KEY = exports.CLAIMABLE_COLLATERAL_REDUCTION_FACTOR_KEY = exports.CLAIMABLE_COLLATERAL_DELAY_KEY = exports.MAX_POSITION_IMPACT_FACTOR_FOR_LIQUIDATIONS_KEY = exports.MAX_PNL_FACTOR_FOR_TRADERS_KEY = exports.MAX_PNL_FACTOR_FOR_DEPOSITS_KEY = exports.MAX_PNL_FACTOR_FOR_WITHDRAWALS_KEY = exports.MAX_PNL_FACTOR_KEY = exports.THRESHOLD_FOR_DECREASE_FUNDING = exports.THRESHOLD_FOR_STABLE_FUNDING = exports.MAX_FUNDING_FACTOR_PER_SECOND = exports.MIN_FUNDING_FACTOR_PER_SECOND = exports.FUNDING_DECREASE_FACTOR_PER_SECOND = exports.FUNDING_INCREASE_FACTOR_PER_SECOND = exports.FUNDING_EXPONENT_FACTOR_KEY = exports.FUNDING_FACTOR_KEY = exports.TOTAL_BORROWING_KEY = exports.CUMULATIVE_BORROWING_FACTOR_KEY = exports.BORROWING_EXPONENT_FACTOR_KEY = exports.BORROWING_FACTOR_KEY = exports.NONCE_KEY = exports.MAX_OPEN_INTEREST_KEY = exports.OPEN_INTEREST_RESERVE_FACTOR_KEY = exports.RESERVE_FACTOR_KEY = exports.MAX_POOL_AMOUNT_KEY = exports.MAX_POOL_USD_FOR_DEPOSIT_KEY = exports.POOL_AMOUNT_KEY = exports.OPEN_INTEREST_IN_TOKENS_KEY = exports.OPEN_INTEREST_KEY = exports.FEE_RECEIVER_POSITION_FACTOR_KEY = exports.FEE_RECEIVER_SWAP_FACTOR_KEY = exports.FEE_RECEIVER_WITHDRAWAL_FACTOR_KEY = exports.BORROWING_FEE_RECEIVER_FACTOR_KEY = exports.FEE_RECEIVER_DEPOSIT_FACTOR_KEY = exports.ATOMIC_SWAP_FEE_FACTOR_KEY = exports.SWAP_FEE_FACTOR_KEY = exports.SWAP_IMPACT_EXPONENT_FACTOR_KEY = exports.SWAP_IMPACT_FACTOR_KEY = exports.POSITION_FEE_FACTOR_KEY = exports.POSITION_IMPACT_EXPONENT_FACTOR_KEY = exports.MAX_POSITION_IMPACT_FACTOR_KEY = exports.POSITION_IMPACT_FACTOR_KEY = void 0;
exports.MULTICHAIN_BALANCE = exports.SUBACCOUNT_EXPIRES_AT = exports.ABOVE_OPTIMAL_USAGE_BORROWING_FACTOR = exports.BASE_BORROWING_FACTOR = exports.OPTIMAL_USAGE_FACTOR = exports.MAX_AUTO_CANCEL_ORDERS_KEY = exports.GLV_PER_MARKET_GAS_LIMIT = exports.GLV_WITHDRAWAL_GAS_LIMIT = exports.GLV_DEPOSIT_GAS_LIMIT = exports.GLV_SHIFT_MIN_INTERVAL = exports.GLV_SHIFT_LAST_EXECUTED_AT = exports.IS_GLV_MARKET_DISABLED = exports.GLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT = exports.MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY = exports.GLV_MAX_MARKET_TOKEN_BALANCE_USD = exports.SUBACCOUNT_AUTO_TOP_UP_AMOUNT = exports.SUBACCOUNT_INTEGRATION_ID = exports.SUBACCOUNT_ORDER_ACTION = exports.SUBACCOUNT_ACTION_COUNT = exports.MAX_ALLOWED_SUBACCOUNT_ACTION_COUNT = exports.SUBACCOUNT_LIST_KEY = exports.UI_FEE_FACTOR = exports.IS_MARKET_DISABLED_KEY = exports.AFFILIATE_REWARD_KEY = exports.VIRTUAL_INVENTORY_FOR_SWAPS_KEY = exports.VIRTUAL_INVENTORY_FOR_POSITIONS_KEY = exports.VIRTUAL_MARKET_ID_KEY = exports.VIRTUAL_TOKEN_ID_KEY = exports.CLAIMABLE_FUNDING_AMOUNT = exports.ACCOUNT_ORDER_LIST_KEY = exports.ORDER_LIST_KEY = exports.POSITION_LIST_KEY = exports.MARKET_LIST_KEY = exports.ESTIMATED_GAS_FEE_MULTIPLIER_FACTOR = exports.ESTIMATED_GAS_FEE_PER_ORACLE_PRICE = exports.ESTIMATED_GAS_FEE_BASE_AMOUNT_V2_1 = exports.NATIVE_TOKEN_TRANSFER_GAS_LIMIT_KEY = exports.TOKEN_TRANSFER_GAS_LIMIT_KEY = exports.SINGLE_SWAP_GAS_LIMIT_KEY = exports.SHIFT_GAS_LIMIT_KEY = exports.SWAP_ORDER_GAS_LIMIT_KEY = exports.DECREASE_ORDER_GAS_LIMIT_KEY = exports.INCREASE_ORDER_GAS_LIMIT_KEY = exports.WITHDRAWAL_GAS_LIMIT_KEY = exports.DEPOSIT_GAS_LIMIT_KEY = exports.MAX_LEVERAGE_KEY = exports.MIN_POSITION_SIZE_USD_KEY = exports.MIN_COLLATERAL_FACTOR_FOR_OPEN_INTEREST_MULTIPLIER_KEY = exports.MIN_COLLATERAL_FACTOR_KEY = exports.MIN_COLLATERAL_USD_KEY = void 0;
exports.singleSwapGasLimitKey = exports.shiftGasLimitKey = exports.withdrawalGasLimitKey = exports.depositGasLimitKey = exports.orderKey = exports.swapImpactPoolAmountKey = exports.maxPositionImpactFactorForLiquidationsKey = exports.positionImpactPoolDistributionRateKey = exports.minPositionImpactPoolAmountKey = exports.positionImpactPoolAmountKey = exports.maxPnlFactorKey = exports.thresholdForDecreaseFundingKey = exports.thresholdForStableFundingKey = exports.maxFundingFactorPerSecondKey = exports.minFundingFactorPerSecondKey = exports.fundingDecreaseFactorPerSecondKey = exports.fundingIncreaseFactorPerSecondKey = exports.fundingExponentFactorKey = exports.fundingFactorKey = exports.totalBorrowingKey = exports.cumulativeBorrowingFactorKey = exports.borrowingExponentFactorKey = exports.borrowingFactorKey = exports.maxOpenInterestKey = exports.openInterestReserveFactorKey = exports.reserveFactorKey = exports.poolAmountKey = exports.openInterestInTokensKey = exports.openInterestKey = exports.atomicSwapFeeFactorKey = exports.swapFeeFactorKey = exports.swapImpactExponentFactorKey = exports.swapImpactFactorKey = exports.positionFeeFactorKey = exports.maxPositionImpactFactorKey = exports.positionImpactExponentFactorKey = exports.positionImpactFactorKey = exports.isGlvDisabledKey = exports.glvMaxMarketTokenBalanceAmountKey = exports.glvMaxMarketTokenBalanceUsdKey = exports.glvShiftMinIntervalKey = exports.glvShiftLastExecutedAtKey = exports.subaccountExpiresAtKey = exports.GENERAL_CLAIM_FEATURE_DISABLED = exports.CLAIM_TERMS_KEY = exports.GMX_SIMULATION_ORIGIN = exports.REQUEST_EXPIRATION_TIME_KEY = exports.GELATO_RELAY_FEE_MULTIPLIER_FACTOR_KEY = exports.GASLESS_FEATURE_DISABLED_KEY = exports.PRICE_FEED_KEY = void 0;
exports.claimsDisabledKey = exports.claimTermsKey = exports.gaslessFeatureDisabledKey = exports.priceFeedKey = exports.multichainBalanceKey = exports.subaccountAutoTopUpAmountKey = exports.subaccountIntegrationIdKey = exports.maxLendableImpactUsdKey = exports.maxLendableImpactFactorForWithdrawalsKey = exports.maxLendableImpactFactorKey = exports.subaccountActionCountKey = exports.maxAllowedSubaccountActionCountKey = exports.subaccountListKey = exports.uiFeeFactorKey = exports.maxPoolAmountKey = exports.maxPoolUsdForDepositKey = exports.isMarketDisabledKey = exports.affiliateRewardKey = exports.virtualInventoryForPositionsKey = exports.virtualInventoryForSwapsKey = exports.virtualMarketIdKey = exports.virtualTokenIdKey = exports.claimableFundingAmountKey = exports.hashedPositionKey = exports.minCollateralFactorForOpenInterest = exports.minCollateralFactorForLiquidationKey = exports.minCollateralFactorKey = exports.accountOrderListKey = exports.swapOrderGasLimitKey = exports.decreaseOrderGasLimitKey = exports.increaseOrderGasLimitKey = void 0;
...
exports.CLAIMABLE_COLLATERAL_DELAY_KEY = (0, hash_1.hashString)("CLAIMABLE_COLLATERAL_DELAY");
exports.CLAIMABLE_COLLATERAL_REDUCTION_FACTOR_KEY = (0, hash_1.hashString)("CLAIMABLE_COLLATERAL_REDUCTION_FACTOR");
exports.CLAIMABLE_COLLATERAL_TIME_DIVISOR_KEY = (0, hash_1.hashString)("CLAIMABLE_COLLATERAL_TIME_DIVISOR");
exports.MAX_LENDABLE_IMPACT_FACTOR_KEY = (0, hash_1.hashString)("MAX_LENDABLE_IMPACT_FACTOR");
exports.MAX_LENDABLE_IMPACT_USD_KEY = (0, hash_1.hashString)("MAX_LENDABLE_IMPACT_USD");
exports.MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS_KEY = (0, hash_1.hashString)("MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS");
exports.LENT_POSITION_IMPACT_POOL_AMOUNT_KEY = (0, hash_1.hashString)("LENT_POSITION_IMPACT_POOL_AMOUNT");
...
exports.SUBACCOUNT_INTEGRATION_ID = (0, hash_1.hashString)("SUBACCOUNT_INTEGRATION_ID");
...
exports.MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY = (0, hash_1.hashString)("MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION");
...
exports.MULTICHAIN_BALANCE = (0, hash_1.hashString)("MULTICHAIN_BALANCE");
...
exports.CLAIM_TERMS_KEY = (0, hash_1.hashString)("CLAIM_TERMS");
exports.GENERAL_CLAIM_FEATURE_DISABLED = (0, hash_1.hashString)("GENERAL_CLAIM_FEATURE_DISABLED");
...
function withdrawalGasLimitKey() {
    return exports.WITHDRAWAL_GAS_LIMIT_KEY;
}
...
function minCollateralFactorForLiquidationKey(market) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.MIN_COLLATERAL_FACTOR_FOR_LIQUIDATION_KEY, market]);
}
exports.minCollateralFactorForLiquidationKey = minCollateralFactorForLiquidationKey;
...
function maxLendableImpactFactorKey(market) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.MAX_LENDABLE_IMPACT_FACTOR_KEY, market]);
}
exports.maxLendableImpactFactorKey = maxLendableImpactFactorKey;
function maxLendableImpactFactorForWithdrawalsKey(market) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS_KEY, market]);
}
exports.maxLendableImpactFactorForWithdrawalsKey = maxLendableImpactFactorForWithdrawalsKey;
function maxLendableImpactUsdKey(market) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.MAX_LENDABLE_IMPACT_USD_KEY, market]);
}
exports.maxLendableImpactUsdKey = maxLendableImpactUsdKey;
function subaccountIntegrationIdKey(account, subaccount) {
    return (0, hash_1.hashData)(["bytes32", "address", "address"], [exports.SUBACCOUNT_INTEGRATION_ID, account, subaccount]);
}
exports.subaccountIntegrationIdKey = subaccountIntegrationIdKey;
...
function multichainBalanceKey(account, token) {
    return (0, hash_1.hashData)(["bytes32", "address", "address"], [exports.MULTICHAIN_BALANCE, account, token]);
}
exports.multichainBalanceKey = multichainBalanceKey;
...
function claimTermsKey(distributionId) {
    return (0, hash_1.hashData)(["bytes32", "uint256"], [exports.CLAIM_TERMS_KEY, distributionId]);
}
exports.claimTermsKey = claimTermsKey;
function claimsDisabledKey(distributionId) {
    return (0, hash_1.hashData)(["bytes32", "uint256"], [exports.GENERAL_CLAIM_FEATURE_DISABLED, distributionId]);
}
exports.claimsDisabledKey = claimsDisabledKey;
