...
import { shouldUseApiTrades, useAccountTrades, convertApiTradesToTradeActions } from "@/modules/cex/lib/api";
...
export function useTradeHistory(
  ...
  // Feature Flag: 使用 API 数据源或 GraphQL 数据源
  ...
  // For API data source, convert directly to TradeAction format (bypasses processRawTradeActions)
  ...
  // For GraphQL data source, use the raw SubsquidTradeAction format
  ...
  // For API data source, use directly converted TradeActions (no processing needed)
  // For GraphQL data source, use processRawTradeActions
