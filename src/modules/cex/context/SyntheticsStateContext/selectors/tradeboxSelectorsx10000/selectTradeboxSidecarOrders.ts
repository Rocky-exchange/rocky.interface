...
export const selectTradeboxSidecarOrdersSlEntries = (state: SyntheticsState) => state.tradeboxx10000.sidecarOrders.slEntries;
export const selectTradeboxSidecarOrdersSetSlEntries = (state: SyntheticsState) =>
  state.tradeboxx10000.sidecarOrders.setSlEntries;
export const selectTradeboxSidecarOrdersTpEntries = (state: SyntheticsState) => state.tradeboxx10000.sidecarOrders.tpEntries;
export const selectTradeboxSidecarOrdersSetTpEntries = (state: SyntheticsState) =>
  state.tradeboxx10000.sidecarOrders.setTpEntries;
export const selectTradeboxSidecarOrdersLimitEntries = (state: SyntheticsState) =>
  state.tradeboxx10000.sidecarOrders.limitEntries;
export const selectTradeboxSidecarOrdersSetLimitEntries = (state: SyntheticsState) =>
  state.tradeboxx10000.sidecarOrders.setLimitEntries;
export const selectTradeboxSidecarEntriesSetIsUntouched = (state: SyntheticsState) =>
  state.tradeboxx10000.sidecarOrders.setIsUntouched;
...
export const makeSelectTradeboxSidecarOrdersEntriesIsUntouched = createSelectorFactory((group: "tp" | "sl" | "limit") =>
  createSelector(function selectSidecarOrdersEntriesIsUntouchedByGroup(q) {
    return {
      tp: () => q((state) => state.tradeboxx10000.sidecarOrders.tpEntriesIsUntouched),
      sl: () => q((state) => state.tradeboxx10000.sidecarOrders.slEntriesIsUntouched),
      limit: () => q((state) => state.tradeboxx10000.sidecarOrders.limitEntriesIsUntouched),
    }[group]();
  })
);
