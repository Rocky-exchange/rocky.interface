...
import { selectIsLeverageSliderEnabled, selectIsPnlInLeverage } from "context/SyntheticsStateContext/selectors/settingsSelectors";
import { selectSelectedMarketVisualMultiplier } from "context/SyntheticsStateContext/selectors/shared/marketSelectors";
import {
...
const selectOnlyOnTradeboxPagex10000 = <T>(s: SyntheticsState, selection: T) =>
  s.pageType === "x10000trade" ? selection : undefined;
export const selectTradeboxState = (s: SyntheticsState) => s.tradeboxx10000;
export const selectTradeboxTradeType = (s: SyntheticsState) => s.tradeboxx10000.tradeType;
export const selectTradeboxTradeMode = (s: SyntheticsState) => s.tradeboxx10000.tradeMode;
export const selectTradeboxFromTokenAddress = (s: SyntheticsState) => s.tradeboxx10000.fromTokenAddress;
export const selectTradeboxIsFromTokenGmxAccount = (s: SyntheticsState) => s.tradeboxx10000.isFromTokenGmxAccount;
export const selectTradeboxToTokenAddress = (s: SyntheticsState) => s.tradeboxx10000.toTokenAddress;
export const selectTradeboxMarketAddress = (s: SyntheticsState) =>
  selectOnlyOnTradeboxPagex10000(s, s.tradeboxx10000.marketAddress);
export const selectTradeboxMarketInfo = (s: SyntheticsState) => s.tradeboxx10000?.marketInfo;
export const selectTradeboxCollateralTokenAddress = (s: SyntheticsState) =>
  selectOnlyOnTradeboxPagex10000(s, s.tradeboxx10000.collateralAddress);
export const selectTradeboxCollateralToken = (s: SyntheticsState) => s.tradeboxx10000.collateralToken;
export const selectTradeboxAvailableTradeModes = (s: SyntheticsState) => s.tradeboxx10000.availableTradeModes;
export const selectTradeboxAvailableTokensOptions = (s: SyntheticsState) => s.tradeboxx10000.availableTokensOptions;
export const selectTradeboxFromTokenInputValue = (s: SyntheticsState) => s.tradeboxx10000.fromTokenInputValue;
export const selectTradeboxToTokenInputValue = (s: SyntheticsState) => s.tradeboxx10000.toTokenInputValue;
export const selectTradeboxStage = (s: SyntheticsState) => s.tradeboxx10000.stage;
export const selectTradeboxFocusedInput = (s: SyntheticsState) => s.tradeboxx10000.focusedInput;
export const selectTradeboxDefaultTriggerAcceptablePriceImpactBps = (s: SyntheticsState) =>
  s.tradeboxx10000.defaultTriggerAcceptablePriceImpactBps;
export const selectTradeboxSetDefaultTriggerAcceptablePriceImpactBps = (s: SyntheticsState) =>
  s.tradeboxx10000.setDefaultTriggerAcceptablePriceImpactBps;
export const selectTradeboxSelectedTriggerAcceptablePriceImpactBps = (s: SyntheticsState) =>
  s.tradeboxx10000.selectedTriggerAcceptablePriceImpactBps;
export const selectTradeboxSetSelectedAcceptablePriceImpactBps = (s: SyntheticsState) =>
  s.tradeboxx10000.setSelectedAcceptablePriceImpactBps;
export const selectTradeboxDefaultAllowedSwapSlippageBps = (s: SyntheticsState) =>
  s.tradeboxx10000.defaultAllowedSwapSlippageBps;
export const selectTradeboxSetDefaultAllowedSwapSlippageBps = (s: SyntheticsState) =>
  s.tradeboxx10000.setDefaultAllowedSwapSlippageBps;
export const selectTradeboxSelectedAllowedSwapSlippageBps = (s: SyntheticsState) =>
  s.tradeboxx10000.selectedAllowedSwapSlippageBps;
export const selectTradeboxSetSelectedAllowedSwapSlippageBps = (s: SyntheticsState) =>
  s.tradeboxx10000.setSelectedAllowedSwapSlippageBps;
export const selectTradeboxCloseSizeInputValue = (s: SyntheticsState) => s.tradeboxx10000.closeSizeInputValue;
export const selectTradeboxTriggerPriceInputValue = (s: SyntheticsState) => s.tradeboxx10000.triggerPriceInputValue;
export const selectTradeboxTriggerRatioInputValue = (s: SyntheticsState) => s.tradeboxx10000.triggerRatioInputValue;
// Separate TP/SL input value selectors
export const selectTradeboxTakeProfitPriceInputValue = (s: SyntheticsState) => s.tradeboxx10000.takeProfitPriceInputValue;
export const selectTradeboxStopLossPriceInputValue = (s: SyntheticsState) => s.tradeboxx10000.stopLossPriceInputValue;
export const selectTradeboxLeverageOption = (s: SyntheticsState) => s.tradeboxx10000.leverageOption;
export const selectTradeboxKeepLeverage = (s: SyntheticsState) => s.tradeboxx10000.keepLeverage;
export const selectTradeboxSetActivePosition = (s: SyntheticsState) => s.tradeboxx10000.setActivePosition;
export const selectTradeboxSetActiveOrder = (s: SyntheticsState) => s.tradeboxx10000.setActiveOrder;
export const selectTradeboxSetToTokenAddress = (s: SyntheticsState) => s.tradeboxx10000.setToTokenAddress;
export const selectTradeboxSetTradeConfig = (s: SyntheticsState) => s.tradeboxx10000.setTradeConfig;
export const selectTradeboxSetKeepLeverage = (s: SyntheticsState) => s.tradeboxx10000.setKeepLeverage;
export const selectTradeboxSetCollateralAddress = (s: SyntheticsState) => s.tradeboxx10000.setCollateralAddress;
export const selectTradeboxAdvancedOptions = (s: SyntheticsState) => s.tradeboxx10000.advancedOptions;
export const selectTradeboxSetAdvancedOptions = (s: SyntheticsState) => s.tradeboxx10000.setAdvancedOptions;
export const selectTradeboxAllowedSlippage = (s: SyntheticsState) => s.tradeboxx10000.allowedSlippage;
export const selectSetTradeboxAllowedSlippage = (s: SyntheticsState) => s.tradeboxx10000.setAllowedSlippage;
export const selectTradeboxTokensAllowance = (s: SyntheticsState) => s.tradeboxx10000.tokensAllowance;
export const selectTradeBoxTokensAllowanceLoaded = (s: SyntheticsState) => s.tradeboxx10000.tokensAllowance.isLoaded;
export const selectTradeboxTwapDuration = (s: SyntheticsState) => s.tradeboxx10000.duration;
export const selectTradeboxTwapNumberOfParts = (s: SyntheticsState) => s.tradeboxx10000.numberOfParts;
...
export const getTradeBoxLeverageStrategy = (s: SyntheticsState) => {
  ...
  const focusedInput = s.tradeboxx10000.focusedInput;
...
export const selectTradeboxMaxLeverage = createSelector((q) => {
  const minCollateralFactor = q((s) => s.tradeboxx10000.marketInfo?.minCollateralFactor);
...
export const selectTradeboxLeverageSliderMarks = createSelector((q) => {
  // TODO: 10000倍杠杆滑块标记点配置 - 在以后迭代版本中启用
  // x10000 页面固定返回包含 10000 的 marks
  // 需要调用一次 query 以满足 createSelector 的要求
  q(selectTradeboxMaxLeverage);
  // return [1, 2, 5, 10, 25, 50, 10000];
...
export const selectTradeboxToToken = createSelector((q) => {
  ...
  // First try to get from tokensData
  const tokenFromTokensData = q((state) => getByKey(selectTokensData(state), toTokenAddress));
  if (tokenFromTokensData) {
    return tokenFromTokensData;
  }

  // For x10000 mode, if token is not in tokensData, try to find it in marketsInfoData
  // This handles synthetic tokens like "x10000-sol" that are created from API data
  // Check if it's a synthetic address (starts with "x10000-")
  if (toTokenAddress && toTokenAddress.startsWith("x10000-") && marketsInfoData) {
    // Find market by indexTokenAddress
    const market = Object.values(marketsInfoData).find(
      (m) => m.indexTokenAddress === toTokenAddress || m.indexTokenAddress.toLowerCase() === toTokenAddress.toLowerCase()
    );
