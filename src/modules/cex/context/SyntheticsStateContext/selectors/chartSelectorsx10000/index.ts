...
/**
 * x10000 version of selectChartToken
 * Reads from tradeboxx10000 state instead of tradebox
 */
export const selectChartTokenx10000 = createSelector((q) => {
...
export const selectAvailableChartTokensx10000 = createSelector(function selectAvailableChartTokensx10000(q) {
  const fromTokenAddress = q(selectTradeboxFromTokenAddress);
  const toTokenAddress = q(selectTradeboxToTokenAddress);
...
export const selectChartHeaderInfox10000 = createSelector((q) => {
