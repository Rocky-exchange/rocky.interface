 ...
 *
 * For x10000 mode, we bypass the normal processRawTradeActions pipeline
...
/**
 * Create mock TokenData for x10000 mode
...
/**
 * Create mock market info for x10000 mode
 ...
 * with mock market/token data for x10000 mode rendering
 */
export function convertApiTradeToPositionTradeAction(
  ...
  const marketAddress = `x10000-${baseAsset}-USD`;
 ...
 * This bypasses processRawTradeActions for x10000 mode
 */
