...
export const useIsCurtainOpenx10000 = createGlobalState(false);

export function Curtainx10000({
  children,
  header,
  dataQa,
}: PropsWithChildren<{
  ...
  const [externalIsCurtainOpen, setExternalIsCurtainOpen] = useIsCurtainOpenx10000();
