...
import { useRequiredActionsx10000 as useRequiredActions } from "./useRequiredActionsx10000";
import { useTPSLSummaryExecutionFeex10000 as useTPSLSummaryExecutionFee } from "./useTPSLSummaryExecutionFeex10000";

export function useSidecarOrderPayloadsx10000() {
