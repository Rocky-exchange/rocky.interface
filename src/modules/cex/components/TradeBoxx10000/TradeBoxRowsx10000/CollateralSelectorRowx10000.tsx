...
import { selectTradeboxAvailableAndDisabledTokensForCollateral } from "@/modules/cex/context/SyntheticsStateContext/selectors/tradeboxSelectorsx10000/selectTradeboxAvailableAndDisabledTokensForCollateral";
...
import { useCollateralInTooltipContentx10000 as useCollateralInTooltipContent } from "../hooks/useCollateralInTooltipContentx10000";
...
export function CollateralSelectorRowx10000(p: Props) {
  ...
  return (
    <>
      <SyntheticsInfoRow
        label={<Trans>Collateral In</Trans>}
        value={
          <CollateralSelector
