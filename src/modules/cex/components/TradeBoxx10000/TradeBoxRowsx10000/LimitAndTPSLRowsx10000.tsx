...
import { EntryButtonx10000 as EntryButton } from "../components/EntryButtonx10000";
import { SideOrderEntriesx10000 as SideOrderEntries } from "../components/SideOrderEntriesx10000";
...
export function LimitAndTPSLRowsx10000({ hasExistingLimitOrder }: { hasExistingLimitOrder: boolean }) {
  return (
...
export function LimitAndTPSLGroupx10000() {
  ...
  return (
    <ExpandableRow
      ...
      withToggleSwitch
    >
      <LimitAndTPSLRowsx10000 hasExistingLimitOrder={hasExistingLimitOrder} />
    </ExpandableRow>
  );
}
