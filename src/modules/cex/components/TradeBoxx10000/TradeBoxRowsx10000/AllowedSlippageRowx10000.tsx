...
import { useTradeboxChangesx10000 as useTradeboxChanges } from "../hooks/useTradeboxChangesx10000";

export function AllowedSlippageRowx10000({ slippageInputId }: { slippageInputId: string }) {
