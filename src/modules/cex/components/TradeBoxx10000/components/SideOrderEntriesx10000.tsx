...
import { selectTradeboxMarketInfo } from "@/modules/cex/context/SyntheticsStateContext/selectors/tradeboxSelectorsx10000";
...
import { EntryButtonx10000 as EntryButton } from "./EntryButtonx10000";
...
export function SideOrderEntriesx10000({ entriesInfo, displayMode }: SidecarEntriesProps) {
