...
import { useExpressTradingWarningsx10000 } from "./hooks/useShowOneClickTradingInfox10000";

export function ExpressTradingWarningCardx10000({
  expressParams,
  payTokenAddress,
  isWrapOrUnwrap,
  disabled,
  ...
  } = useExpressTradingWarningsx10000({ expressParams, payTokenAddress, isWrapOrUnwrap, isGmxAccount });
