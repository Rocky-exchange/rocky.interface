...
export function OrderFormPanel() {
  ...
  const {
    mode, setMode,
    side, setSide,
    leverageValue, setLeverageValue,
    pendingLeverageValue, setPendingLeverageValue,
    pendingLeverageInput, setPendingLeverageInput,
    marginTab, setMarginTab,
    pendingMarginTab, setPendingMarginTab,
    advancedOpen, setAdvancedOpen,
    leverageModalOpen, setLeverageModalOpen,
    marginModalOpen, setMarginModalOpen,
  } = useOrderFormState({ maxLeverage });
  ...
  }, [leverageValue, maxLeverage, setLeverageValue, setPendingLeverageInput, setPendingLeverageValue]);
