...
const CANTON_ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
...
export function SettingsContextProvider({ children }: { children: ReactNode }) {
  ...
  }, [hasOverriddenDefaultArb30ExecutionFeeBufferBpsKey, setHasOverriddenDefaultArb30ExecutionFeeBufferBpsKey]);
  ...
  const contextState: SettingsContextType = useMemo(() => {
    return {
      ...
      setTenderlyAccessKey: noop,
      setTenderlyAccountSlug: noop,
      setTenderlyProjectSlug: noop,
      setTenderlySimulationEnabled: noop,
      tenderlyAccessKey: undefined,
      tenderlyAccountSlug: undefined,
      tenderlyProjectSlug: undefined,
      tenderlySimulationEnabled: false,

      isSettingsVisible,
      setIsSettingsVisible,

      expressOrdersEnabled: false,
      setExpressOrdersEnabled: noop,
      gasPaymentTokenAddress: CANTON_ZERO_ADDRESS,
      setGasPaymentTokenAddress: noop,

      externalSwapsEnabled: false,
      setExternalSwapsEnabled: noop,
