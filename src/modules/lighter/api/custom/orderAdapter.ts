...
import { DEFAULT_COLLATERAL_ADDRESS } from "config/custom/contracts";
...
export function convertApiOrderToSdk(
  ...
  return {
    ...
    callbackContract: CANTON_ZERO_ADDRESS,
    ...
    autoCancel: false,
    data: [],
    uiFeeReceiver: CANTON_ZERO_ADDRESS,
