...
export function usePositionsInfoRequest(
  ...
  return useMemo(() => {
    ...
    const positionsInfoData = Object.keys(positionsData).reduce((acc: PositionsInfoData, positionKey: string) => {
      ...
      const shouldUseOriginalLeverage = isTradeMode && position.originalLeverage !== undefined;

      const leverage = shouldUseOriginalLeverage
      ...
      const leverageWithPnl = shouldUseOriginalLeverage
        ? position.originalLeverage
        : getLeverage({
            sizeInUsd: position.sizeInUsd,
            collateralUsd: collateralUsd,
      ...
      const leverageWithoutPnl = shouldUseOriginalLeverage
        ? position.originalLeverage
        : getLeverage({
            sizeInUsd: position.sizeInUsd,
            collateralUsd: collateralUsd,
