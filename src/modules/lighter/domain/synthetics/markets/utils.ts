...
export function getTradeboxLeverageSliderMarks(maxLeverage: number) {
  ...
  // For API-backed trading, when allowedLeverage >= 1000
  // (maxLeverage >= 20000000, i.e. 10000x), the slider can expose a 10000 mark.
  // This branch stays disabled for now.
  // if (allowedLeverage >= 1000) {
  //   return [0.1, 1, 2, 5, 10, 25, 50, 10000];
  // }
  if (allowedLeverage >= 125) {
    return [1, 2, 5, 10, 50, 100, allowedLeverage];
  } else if (allowedLeverage >= 120) {
    return [1, 2, 5, 10, 30, 60, 120];
  } else if (allowedLeverage >= 110) {
    return [1, 2, 5, 10, 25, 50, 100, 110];
  } else if (allowedLeverage >= 100) {
    return [1, 2, 5, 10, 25, 50, 100];
  } else if (allowedLeverage >= 90) {
    return [1, 2, 5, 10, 50, 90];
  } else if (allowedLeverage >= 80) {
    return [1, 2, 5, 10, 50, 80];
  } else if (allowedLeverage >= 75) {
    return [1, 2, 5, 10, 30, 50, 75];
  } else if (allowedLeverage >= 70) {
    return [1, 2, 5, 10, 30, 50, 70];
  } else if (allowedLeverage >= 60) {
    return [1, 2, 5, 10, 25, 50, 60];
