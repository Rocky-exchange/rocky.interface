...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving Rocky.io and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com">rocky front end</ExternalLink>, hosted and served on
      ...
      <Trans>
        ...
        {/* GMX_DOCS_LINK_COMMENTED: https://docs.gmx.io/docs/community/frontends */}
        <span className="text-blue-300">docs</span>.
        <br />
        <br />
        By clicking Agree you accept the <ExternalLink href="https://google.com">
          T&Cs
        </ExternalLink>{" "}
        and <ExternalLink href="https://google.com">Referral T&Cs</ExternalLink>.
        <br />
        <br />
      </Trans>
      <div className="mb-15">
