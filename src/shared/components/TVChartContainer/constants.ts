...
const enabledFeatures: ChartingLibraryFeatureset[] = [
  ...
  "create_volume_indicator_by_default", // Enable automatic volume indicator creation
];

export const defaultChartProps = {
  theme: "dark",
  locale: "en",
  // In Vite dev 环境下，public 目录已经作为站点根路径挂载，
  // 不能再加 "public/" 前缀，否则请求会变成 /public/charting_library/...
  // 导致图表静态资源 404，K 线不显示。
  // 统一改为根路径下的 /charting_library/，与生产环境保持一致。
