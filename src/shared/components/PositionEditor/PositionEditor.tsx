...
export function PositionEditor() {
  ...
  const localizedOperationLabels = useLocalizedMap(isX10000Mode ? X10000_OPERATION_LABELS : OPERATION_LABELS);
        ...
        {position && (
          <div className="flex flex-col gap-12">
            ...
            <BuyInputSection
              ...
              qa="amount-input"
            >
              {/* x10000 mode: fixed USDT, no token selector */}
              {isX10000Mode ? (
                "USDT"
              ) : hasMultipleTokens ? (
            ...
            <div className="mt-16 flex flex-col gap-14">
              {/* Hide DEX-specific price impact warning in x10000 mode */}
              {!isX10000Mode && (
              ...
              {/* Hide DEX-specific express trading warning in x10000 mode */}
              {!isX10000Mode && (
              ...
              {/* Hide Receive row in x10000 mode - collateral changes are instant via API */}
              {!isX10000Mode && !isDeposit && (
                <SyntheticsInfoRow
                  label={t`Receive`}
              ...
              {/* Hide Liquidation Price in x10000 mode */}
              {!isX10000Mode && (
                <SyntheticsInfoRow
              ...
              {/* Hide advanced rows in x10000 mode */}
              {!isX10000Mode && (
