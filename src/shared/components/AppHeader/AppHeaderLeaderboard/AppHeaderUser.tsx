// Auto-generated AppHeaderUser for /leaderboard route
...
import { LeaderboardAddressDropdown } from "./LeaderboardAddressDropdown";
  ...
  return (
    <div className="flex items-center gap-8">
      <div data-qa="user-address">
        <LeaderboardAddressDropdown account={account} />
      </div>
