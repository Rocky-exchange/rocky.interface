...
export function InterviewToast({ type, onButtonClick }: Props) {
    ...
    return (
      <div>
        ...
        <ColorfulButtonLink color="blue" onClick={onButtonClick}>
          <Trans>Give us your feedback on rocky</Trans>
        </ColorfulButtonLink>
        <br />
        <Trans>
  ...
  if (type === "lp") {
    return (
      <div>
        <Trans>
          We value your experience as rocky Liquidity Provider and invite you to participate in an anonymous one-on-one
          chat.
        </Trans>
        <br />
        <br />
        ...
        <br />
        <ColorfulButtonLink color="blue" onClick={onButtonClick}>
          <Trans>Click here to give us your feedback on rocky</Trans>
        </ColorfulButtonLink>
      </div>
    );
  }
