...
export function InterviewModal({ type, isVisible, setIsVisible }: Props) {
  if (type === "trader") {
    return (
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={t`Anonymous chat with rocky`}>
        <div className="max-w-xl">
          <Trans>
            We want your insights to help improve Rocky. For security reasons, we won't contact you first. Please send the
  ...
  if (type === "lp") {
    return (
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={t`Anonymous chat with rocky team`}>
        <div className="max-w-xl">
          <Trans>
            We want your insights to help improve rocky for Liquidity Providers. For security reasons, we won't contact
