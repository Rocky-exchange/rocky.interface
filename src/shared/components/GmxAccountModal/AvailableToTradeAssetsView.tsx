...
// Virtual chain ID used to represent Rocky Account (off-chain balances)
const GMX_ACCOUNT_CHAIN_ID = 0;
            ...
            <div className="flex items-center gap-16">
              ...
              <div>
                ...
                <div className="text-body-small text-slate-100">
                  {displayToken.chainId === GMX_ACCOUNT_CHAIN_ID ? t`Rocky Account` : getChainName(displayToken.chainId)}
                </div>
              </div>
            </div>
