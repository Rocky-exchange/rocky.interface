...
export const DepositStatusView = () => {
  ...
  const description = isCompleted ? (
    <Trans>Funds are now in your rocky Account.</Trans>
  ) : (
    <Trans>Funds will appear in your rocky Account soon.</Trans>
  );
        ...
        <div className="flex flex-col gap-4 p-12">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-8">
              <div className="size-6 rotate-[45deg] transform rounded-1 bg-blue-300" />
              <span className="text-12 text-typography-secondary">
                <Trans>Faster execution with rocky premium RPCs</Trans>
              </span>
            </div>
            <div className="flex items-center gap-8">
              <div className="size-6 rotate-[45deg] transform rounded-1 bg-blue-300" />
              <span className="text-12 text-typography-secondary">
                <Trans>Reliable rocky-powered transactions</Trans>
              </span>
            </div>
          </div>
        </div>
