...
const X10000_API_DOMAINS: Record<number, string> = {
  [ARBITRUM]: import.meta.env.VITE_PROXY_API_URL || "https://api.rocky.xyz",
  [ARBITRUM_SEPOLIA]: import.meta.env.VITE_PROXY_SEPOLIA_API_URL || "https://api-sepolia.rocky.xyz",
};

// WebSocket URL（与 API 域名相同，仅协议不同）
const X10000_WS_DOMAINS: Record<number, string> = {
  [ARBITRUM]: import.meta.env.VITE_PROXY_WS_URL || "wss://api.rocky.xyz",
  [ARBITRUM_SEPOLIA]: import.meta.env.VITE_PROXY_SEPOLIA_WS_URL || "wss://api-sepolia.rocky.xyz",
};
